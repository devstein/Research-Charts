...
function liquidity_concentration_cusip_hghy_usa_chart() {
    //var to catch any issues while getting data 
    var jqxhr_liquidity_concentration_cusip_hghy_usa = $.get('../../datafiles/widget_data/liquidity_concentration_cusip_hghy_usa.csv', function (data) {
        //set up chart 
        ...
        var options = {
            ...
            chart: {
                ...
                renderTo: 'liquidity_concentration_cusip_hghy_usa_container'
            },
            //set title
            title: {
                text: 'TRACE Traded CUSIPs',
                style: {
                    color: '#4D759E'
                },
                align: 'center'
            ...
            exporting: {
                filename: 'MarketAxess_TRACE_traded_cusip_usa',
        ...
        .fail(function (jqxhr_liqudity_concentration_cusip_hghy_usa, exception) {
            ajaxError(jqxhr_liquidity_concentration_cusip_hghy_usa, exception, '#liquidity_concentration_cusip_hghy_usa_container');
    });
}
...
(function () {
    ...
    liquidity_concentration_cusip_hghy_usa_chart();
})();